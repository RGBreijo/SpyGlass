                        ...
                        <form className="createGoalFormContainer">
                            ...
                            <div className="createGoalInputContainer">
                                ...
                                <div>
                                    ...
                                    <input  type="date" defaultValue={new Date(this.state.targetDate).toISOString().substr(0,10)} onChange={this.setTargetDate} ></input>
                                </div>
                            ...
                            <textarea placeholder="Why do you want to achieve this goal?">{this.state.reason}</textarea>                           
